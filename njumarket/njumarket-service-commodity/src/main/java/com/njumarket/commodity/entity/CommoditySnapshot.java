...
public class CommoditySnapshot {
     ...
     * 从商品实体创建快照
     */
    public static CommoditySnapshot fromCommodity(Commodity commodity, String sellerName, String sellerPhone, String sellerEmail) {
        if (commodity == null) {
            return null;
        }
        ...
        snapshot.setSellerId(commodity.getSellerId());
        snapshot.setSellerName(sellerName);
        snapshot.setSellerPhone(sellerPhone);
        snapshot.setSellerEmail(sellerEmail);

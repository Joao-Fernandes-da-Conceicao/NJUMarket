...
public class OrderServiceImpl implements OrderService {
    ...
    public Result createOrderFromSnapshot(String orderId, com.njumarket.njumarket.dto.OrderSnapshotDTO orderSnapshotDTO) {
        ...
        // 检查当前商品状态
        Commodity commodity = BusinessValidator.requireCommodity(originalOrder.getCommodityId(), commodityRepository);
        BusinessValidator.requireCommodityStatus(commodity, "ON_SHELF");

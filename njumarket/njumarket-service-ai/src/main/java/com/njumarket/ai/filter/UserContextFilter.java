package com.njumarket.ai.filter;

import com.njumarket.ai.entity.User;
 ...
 *   X-User-Id / X-User-Status / X-Username / X-Authenticated
 *
 * 本 Filter 直接读取请求头构建 User 对象，不再调用 auth-service。
 */
@Slf4j
@Component

...
public class OrderSnapshot {
     ...
     * 从订单实体创建快照
     */
    public static OrderSnapshot fromOrder(Order order, CommoditySnapshot commoditySnapshot) {
        if (order == null) {
            return null;
        }
        ...
        if (commoditySnapshot != null) {
            snapshot.setCommoditySnapshotId(commoditySnapshot.getSnapshotId());
        }

...
public class SecurityUtils {
     ...
     */
    public static Admin requireCurrentAdmin() {
        Admin admin = getCurrentAdmin();
        if (admin == null) {
    ...
    public static boolean isSystemAdmin() {
        Admin admin = getCurrentAdmin();
        return admin != null && admin.isSystemAdmin();
    }
     ...
     */
    public static Admin requireSystemAdmin() {
        Admin admin = requireCurrentAdmin();
    ...
    public static boolean hasPermission(String permission) {
        Admin admin = getCurrentAdmin();
        return admin != null && Boolean.TRUE.equals(admin.hasPermission(permission));
    }
    ...
    public static void requirePermission(String permission) {
        Admin admin = requireCurrentAdmin();
        if (!Boolean.TRUE.equals(admin.hasPermission(permission))) {

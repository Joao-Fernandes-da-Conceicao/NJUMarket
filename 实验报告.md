...
**1. 用户登录界面**
![用户登录界面](project_picture/屏幕截图%202025-11-10%20235048.png)

**2. 商品浏览页面**
![商品浏览页面](project_picture/屏幕截图%202025-11-10%20235101.png)

**3. 商品详情页面**
![商品详情页面](project_picture/屏幕截图%202025-11-10%20235113.png)

**4. 订单管理页面**
![订单管理页面](project_picture/屏幕截图%202025-11-10%20235126.png)

**5. 用户个人中心**
![消息聊天界面](project_picture/屏幕截图%202025-11-10%20235140.png)

**6. 消息管理界面**
![用户个人中心](project_picture/屏幕截图%202025-11-10%20235159.png)

#### 管理端运行截图

**7. 管理端后台管理界面**
![管理端后台管理界面](project_picture/屏幕截图%202025-11-10%20235214.png)
